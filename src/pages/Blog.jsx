...
const Blog = () => {
  ...
  const blogPosts = [
    ...
    },
    {
      ...
      excerpt:
        "Strategies to maintain effective Facebook ad targeting in the wake of iOS privacy changes and cookie restrictions.",
      category: "Social Media",
      date: "April 5, 2023",
    ...
    },
    {
      ...
      excerpt:
        "Proven lead generation strategies specifically designed for B2B companies to attract qualified prospects.",
      category: "PPC",
      date: "March 22, 2023",
    ...
    },
    {
      ...
      excerpt:
        "Learn how to set up effective email marketing automation flows that drive repeat purchases and increase customer lifetime value.",
      category: "E-commerce",
      date: "March 10, 2023",
    ...
    },
    {
      ...
      excerpt:
        "How to optimize your website and content for voice search as more users adopt smart speakers and voice assistants.",
      category: "SEO",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Explore the latest marketing insights, trends, and strategies on our blog to help grow your business online."
        />
      </Helmet>
      ...
      >
        <BlogHero>
          ...
          <p style={{ maxWidth: "700px", margin: "0 auto" }}>
            Discover the latest marketing trends, strategies, and insights to
            help grow your business online and maximize your ROI.
          </p>
        </BlogHero>
