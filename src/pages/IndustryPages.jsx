...
export const B2BMarketingPage = () => {
  const pageData = {
    industry: "B2B",
    title:
      "B2B Marketing Agency: Data-Driven Lead Generation for B2B Companies",
    ...
    services: [
      {
        ...
        description:
          "Target specific high-value accounts with personalized marketing campaigns that speak directly to their pain points and goals. Our ABM strategies align sales and marketing for maximum impact.",
      },
      {
        title: "B2B Lead Generation",
        description:
          "Generate qualified leads through multi-channel campaigns that nurture prospects through the buying journey. We focus on quality over quantity to deliver leads that convert.",
      },
      {
        title: "LinkedIn Marketing for B2B",
        description:
          "Leverage the most powerful B2B platform with targeted LinkedIn ad campaigns, content marketing, and engagement strategies that reach decision-makers.",
      },
      {
        title: "B2B Content Marketing",
        description:
          "Create thought leadership content that positions your brand as an industry leader and generates inbound leads through valuable, actionable insights.",
      },
      {
        title: "B2B SEO & Technical Audit",
        description:
          "Optimize your digital presence with comprehensive SEO audits, technical analysis, and content optimization to increase organic visibility to your target audience.",
      },
      {
        title: "Marketing Automation",
        description:
          "Implement scalable marketing automation solutions that nurture leads, score prospects, and deliver personalized experiences throughout the customer journey.",
      },
    ],
    benefits: [
      {
        ...
        description:
          "We base every decision on comprehensive analytics and testing, ensuring your marketing budgets are invested where they'll generate the highest returns.",
      },
      {
        title: "Integrated Sales & Marketing Alignment",
        description:
          "Our approaches bridge the gap between marketing and sales teams, creating cohesive strategies that move prospects efficiently through your pipeline.",
      },
      {
        title: "Enterprise-Level Expertise",
        description:
          "With experience serving major B2B companies across industries, we understand the complexities of enterprise sales cycles and stakeholder management.",
      },
      {
        title: "Mobile-First Optimization",
        description:
          "All our campaigns are built with mobile-first design principles, ensuring decision-makers can engage with your content seamlessly across devices.",
      },
      {
        title: "Performance Transparency",
        description:
          "Clear reporting dashboards show exactly how our strategies are performing, with direct links between marketing activities and revenue generation.",
      },
    ],
    caseStudies: [
      {
        ...
        description:
          "We developed a comprehensive ABM strategy for a B2B SaaS company targeting Fortune 500 financial institutions.",
        results: [
      ...
      },
      {
        ...
        description:
          "Created an integrated digital strategy for a manufacturing equipment company looking to reach new industrial customers.",
        results: [
    ...
    testimonials: [
      {
        quote:
          "Leadwisee transformed our approach to B2B marketing. Their team understood our complex sales cycle and created strategies that not only generated leads but significantly improved our conversion rates.",
        name: "Sarah Johnson",
        position: "CMO",
      ...
      {
        quote:
          "The ABM strategy Leadwisee developed for us has completely changed how we approach our target accounts. We've seen dramatic improvements in engagement from key decision-makers.",
        name: "Michael Chen",
    ...
    faqs: [
      {
        ...
        answer:
          "B2B marketing involves longer sales cycles, multiple stakeholders in the purchasing decision, and typically higher-value transactions. It requires different strategies focused on education, trust-building, and demonstrating ROI rather than emotional appeals often used in B2C marketing.",
      },
      {
        question:
          "What is Account-Based Marketing and why is it effective for B2B?",
        answer:
          "Account-Based Marketing (ABM) treats individual high-value accounts as markets of one, creating personalized campaigns specifically designed for key decision-makers within target companies. It's effective for B2B because it aligns marketing and sales efforts to focus resources on the accounts most likely to generate significant revenue.",
      },
      {
        question: "How do you measure success in B2B marketing campaigns?",
        answer:
          "We measure success through multiple metrics, including qualified lead generation, sales opportunity creation, pipeline value, conversion rates through the funnel, cost per acquisition, and ultimately ROI. For ABM campaigns, we also track engagement metrics with target accounts and stakeholder interactions.",
      },
      {
        question:
          "How long does it typically take to see results from B2B marketing efforts?",
        answer:
          "B2B marketing typically has longer time-to-results than B2C due to extended sales cycles. Initial engagement metrics improve within 1-2 months, lead generation typically shows significant improvements within 3-4 months, and revenue impact generally becomes clear within 6-9 months, depending on your industry and average sales cycle length.",
      },
      {
        question: "How do you approach SEO for B2B companies?",
        answer:
          "Our B2B SEO approach includes comprehensive technical audits, keyword research focused on industry-specific terminology, competitive analysis, and content strategy development. We focus on capturing high-intent search queries from decision-makers and creating conversion-optimized journeys.",
      },
    ],
  };
...
export const ECommerceMarketingPage = () => {
  const pageData = {
    ...
    subtitle:
      "Data-Driven E-Commerce Advertising That Drives Revenue, Not Just Traffic",
    ...
    services: [
      {
        ...
        description:
          "Strategic management of Google Shopping, Facebook/Instagram Shopping, and Amazon advertising campaigns to drive qualified traffic and maximize ROAS.",
      },
      {
        title: "Conversion Rate Optimization",
        description:
          "Data-driven analysis and optimization of your website, product pages, and checkout process to turn more visitors into paying customers.",
      },
      {
        title: "Product Feed Optimization",
        description:
          "Enhancement of your product feeds for better visibility, higher click-through rates, and improved quality scores across shopping platforms.",
      },
      {
        title: "E-Commerce SEO & Content Marketing",
        description:
          "Comprehensive SEO strategies focused on product-specific keywords, category optimization, and content that drives organic traffic and conversions.",
      },
      {
        title: "Email & SMS Marketing Automation",
        description:
          "Personalized email and SMS campaigns that recover abandoned carts, encourage repeat purchases, and maximize customer lifetime value.",
      },
      {
        title: "Mobile-First Marketing Strategies",
        description:
          "Optimization of the mobile shopping experience with responsive designs, accelerated page speeds, and mobile-specific engagement tactics.",
      },
    ],
    benefits: [
      {
        ...
        description:
          "We leverage analytics and testing to guide every marketing decision, ensuring optimal allocation of your advertising budget for maximum returns.",
      },
      {
        title: "Multi-Channel Expertise",
        description:
          "Our team specializes in creating cohesive strategies across Google, Facebook, Instagram, Amazon, and emerging e-commerce platforms.",
      },
      {
        title: "Revenue-Focused Metrics",
        description:
          "We measure success by revenue generated, not just clicks or impressions, ensuring our strategies directly impact your bottom line.",
      },
      {
        title: "Technical Optimization",
        description:
          "Comprehensive SEO audits, page speed analysis, and crawlability improvements to enhance your site's technical foundation.",
      },
      {
        title: "Seasonal Strategy Adaptation",
        description:
          "Proactive adjustment of campaigns to capitalize on seasonal trends, holiday opportunities, and market shifts.",
      },
    ],
    caseStudies: [
      {
        ...
        description:
          "Developed an integrated PPC, SEO, and CRO strategy for a mid-sized fashion retailer looking to scale their online sales.",
        results: [
      ...
      },
      {
        ...
        description:
          "Created a mobile-first marketing strategy for a direct-to-consumer home goods brand targeting millennial shoppers.",
        results: [
    ...
    testimonials: [
      {
        quote:
          "Working with Leadwisee transformed our e-commerce marketing. Their team's expertise in shopping ads and conversion optimization helped us achieve record-breaking sales months consistently.",
      ...
      {
        quote:
          "The product feed optimization and PPC strategies Leadwisee implemented have dramatically improved our ROAS. They truly understand the nuances of e-commerce marketing in a competitive landscape.",
        name: "David Wilson",
    ...
    faqs: [
      {
        ...
        answer:
          "Improving conversion rates requires a multi-faceted approach: optimizing product pages with clear descriptions and high-quality images, streamlining the checkout process, implementing trust signals, using targeted product recommendations, creating urgency with limited-time offers, and continuously A/B testing key elements. Our CRO strategies typically increase conversion rates by 30-50%.",
      },
      {
        question:
          "What's the most effective advertising channel for e-commerce?",
        answer:
          "The most effective channel varies by product type, price point, and target audience. Google Shopping works well for high-intent purchases, while Facebook and Instagram are powerful for discovery-based shopping. Amazon Advertising is crucial if you sell on their marketplace. We recommend a multi-channel approach that creates touchpoints throughout the customer journey.",
      },
      {
      ...
      {
        question:
          "How do you approach e-commerce SEO differently than regular SEO?",
        answer:
      ...
      },
      {
        ...
        answer:
          "We work with all major e-commerce platforms including Shopify, WooCommerce, Magento, BigCommerce, and custom-built solutions. Each platform has unique optimization opportunities, and our team is certified in implementing advanced marketing strategies across all popular e-commerce systems.",
      },
    ],
  };
  ...
  const pageData = {
    ...
    services: [
      ...
      },
      {
        ...
        description:
          "Drive qualified foot traffic to your physical locations through targeted local campaigns, mobile marketing, and location-based advertising.",
      },
      {
        title: "Retail Digital Transformation",
        description:
          "Modernize your retail operations with digital solutions that enhance customer experiences, streamline operations, and increase revenue.",
      },
      {
        title: "Local SEO & Google Business Profile Optimization",
        description:
          "Improve local search visibility with tailored local SEO strategies that help nearby customers find your retail locations when they're ready to buy.",
      },
      {
        title: "Retail Social Media Marketing",
        description:
          "Build community and drive sales with retail-focused social media strategies that showcase products, highlight promotions, and engage local customers.",
      },
      {
        title: "Retail Analytics & Attribution",
        description:
          "Gain clear insights into the customer journey with advanced attribution modeling that connects online activities to in-store purchases.",
      },
    ],
    benefits: [
      {
        ...
        description:
          "Our strategies create consistent brand experiences whether customers shop online, in-store, or through mobile apps.",
      },
      {
        title: "Physical + Digital Expertise",
        description:
          "We combine deep knowledge of traditional retail principles with cutting-edge digital marketing techniques.",
      },
      {
        title: "Local Market Penetration",
        description:
          "Targeted campaigns help you dominate local markets and build strong community connections around each location.",
      },
      {
        title: "Mobile-First Customer Journeys",
        description:
          "We optimize every touchpoint for mobile users, recognizing that most retail research now happens on smartphones.",
      },
      {
        title: "Cross-Channel Measurement",
        description:
          "Advanced analytics solutions help track the full customer journey from online research to in-store purchases.",
      },
    ],
    caseStudies: [
      {
        ...
        description:
          "Developed an omnichannel marketing strategy for a retail chain with 25 locations across the Southeast.",
        results: [
      ...
      },
      {
        ...
        description:
          "Created integrated local marketing campaigns for a home goods retailer expanding into new markets.",
        results: [
    ...
    testimonials: [
      {
        quote:
          "Leadwisee helped us seamlessly integrate our online and in-store marketing efforts. Their strategies significantly increased foot traffic while also growing our e-commerce sales—truly omnichannel results.",
        name: "Robert Greene",
      ...
      {
        quote:
          "The local SEO and mobile marketing strategies Leadwisee implemented have transformed how customers find and engage with our retail locations. They truly understand how to bridge digital and physical retail experiences.",
        name: "Amanda Torres",
        position: "VP of Marketing",
    ...
    faqs: [
      {
        question:
          "What is omnichannel marketing and why is it important for retail?",
        answer:
          "Omnichannel marketing creates a seamless, integrated experience across all channels—website, mobile apps, social media, and physical stores. It's crucial for retail because today's consumers expect consistent experiences regardless of how they interact with your brand. Customers may research online, visit stores to see products, then purchase via mobile app. Omnichannel strategies nurture these complex journeys rather than treating each channel in isolation.",
      },
      {
        question:
          "How can digital marketing drive foot traffic to physical stores?",
        answer:
          'Digital marketing drives store traffic through several tactics: local SEO and map optimization helps nearby customers find you, location-based mobile ads target customers when they\'re in proximity to your stores, "buy online, pick up in store" options blend digital convenience with store visits, and social media promotions can highlight in-store exclusives or events to drive foot traffic.',
      },
      {
        question:
          "How do you measure the effectiveness of retail marketing campaigns?",
        answer:
          "We use multi-touch attribution models that connect online engagement to in-store purchases through tactics like promotion code tracking, dedicated landing pages for in-store offers, foot traffic analysis, customer journey mapping, and point-of-sale integration. This provides a comprehensive view of how marketing activities influence both online and offline sales.",
      },
      {
        question: "What role does mobile marketing play in retail strategy?",
        answer:
          "Mobile marketing is central to modern retail strategy. It includes location-based advertising to reach nearby shoppers, mobile-optimized websites and apps for seamless browsing, mobile loyalty programs and digital wallets for convenient purchasing, push notifications for timely offers, and mobile-based in-store experiences like QR codes for product information.",
      },
      {
  ...
  const pageData = {
    ...
    services: [
      ...
      },
      {
        ...
        description:
          "Create sophisticated paid media campaigns that reach high-net-worth individuals and luxury consumers with elegance and precision.",
      },
      {
        title: "Luxury Influencer Marketing",
        description:
          "Curate partnerships with premium influencers and tastemakers whose audiences and aesthetic align perfectly with your luxury positioning.",
      },
      {
        title: "High-End Social Media Management",
        description:
          "Develop and manage social media presences that showcase your products with the sophistication and visual excellence luxury consumers expect.",
      },
      {
        title: "Fashion SEO & Content Strategy",
        description:
          "Create authoritative content and technical optimization that positions your brand as a leader in luxury and fashion search results.",
      },
      {
        title: "Luxury E-Commerce Experience Optimization",
        description:
          "Enhance your online shopping experience to reflect the same level of service and attention to detail found in your boutiques.",
      },
    ],
    benefits: [
      {
        ...
        description:
          "Our strategies drive growth while carefully protecting your brand's exclusivity and luxury positioning.",
      },
      {
        title: "Aesthetic Excellence",
        description:
          "We maintain impeccable visual standards across all digital touchpoints, ensuring consistency with your brand identity.",
      },
      {
        title: "High-Value Audience Targeting",
        description:
          "Precision targeting reaches affluent consumers and fashion enthusiasts with demonstrated interest in luxury goods.",
      },
      {
        title: "Mobile Luxury Experience",
        description:
          "Mobile-first design creates sophisticated shopping experiences for luxury consumers on their preferred devices.",
      },
      {
        title: "Brand Protection",
        description:
          "Our approach includes brand monitoring and protection strategies to safeguard your reputation in the digital space.",
      },
    ],
    caseStudies: [
      {
        ...
        description:
          "Developed an integrated digital strategy for a luxury fashion brand looking to expand their e-commerce presence while maintaining exclusivity.",
        results: [
      ...
      },
      {
        ...
        description:
          "Created a sophisticated influencer and social media strategy for a premium accessories brand targeting fashion-forward millennials.",
        results: [
    ...
    testimonials: [
      {
        quote:
          "Leadwisee understood the unique challenges of marketing luxury products online. Their strategies helped us increase sales while actually enhancing our brand's exclusive positioning.",
      ...
      {
        quote:
          "The influencer partnerships Leadwisee secured for our brand have been transformative. They found authentic voices that resonate perfectly with our aesthetic and values.",
    ...
    faqs: [
      {
        question:
          "How is marketing for luxury brands different from mass-market brands?",
        answer:
          "Luxury marketing focuses on exclusivity rather than accessibility, emphasizes heritage and craftsmanship over price, targets smaller but higher-value audience segments, maintains meticulous visual standards, and creates desire through scarcity and aspirational positioning. Our strategies respect these principles while adapting them to digital channels.",
      },
      {
  ...
  const pageData = {
    ...
    services: [
      ...
      },
      {
        ...
        description:
          "Specialized healthcare SEO strategies that improve your visibility for treatment-specific keywords and local searches from potential patients.",
      },
      {
        title: "Patient Acquisition Campaigns",
        description:
          "Multi-channel marketing strategies designed to generate qualified patient leads and guide them through the decision-making process.",
      },
      {
        title: "Healthcare Local Marketing",
        description:
          "Location-focused campaigns that establish your practice as the trusted provider in your community through targeted local strategies.",
      },
      {
        title: "HIPAA-Compliant Email Marketing",
        description:
          "Patient nurturing email workflows that maintain strict compliance while educating prospects and encouraging appointment scheduling.",
      },
      {
        title: "Healthcare Reputation Management",
        description:
          "Proactive management of online reviews and ratings to build trust and credibility with potential patients researching providers.",
      },
    ],
    benefits: [
      {
        ...
        description:
          "All our healthcare marketing strategies adhere to HIPAA, FDA, and other relevant regulations governing healthcare advertising.",
      },
      {
    ...
    testimonials: [
      {
        quote:
          "Leadwisee transformed our practice's digital presence while maintaining strict HIPAA compliance. Their healthcare marketing expertise helped us attract exactly the kind of patients we specialize in treating.",
      ...
      {
        quote:
          "The patient acquisition strategies Leadwisee implemented have significantly improved both the quantity and quality of new patients coming to our practice. They truly understand healthcare marketing.",
        name: "Mark Thompson",
    ...
    faqs: [
      {
        question:
          "How do you ensure healthcare marketing campaigns remain HIPAA-compliant?",
        answer:
...
export const EntertainmentMarketingPage = () => {
  const pageData = {
    ...
    title:
      "Entertainment & OTT Marketing Agency: Subscriber Acquisition Experts",
    ...
    services: [
      {
        ...
        description:
          "Multi-channel marketing strategies designed to attract qualified subscribers and convert them through optimized sign-up experiences.",
      },
      {
        title: "OTT Content Promotion",
        description:
          "Strategic campaigns that highlight your most compelling content to drive interest, free trials, and subscription conversions.",
      },
      {
        title: "Audience Retention Optimization",
        description:
          "Data-driven strategies to reduce churn, increase engagement, and maximize the lifetime value of your subscriber base.",
      },
      {
        title: "Entertainment SEO & Content Strategy",
        description:
          "Specialized search optimization that helps your content get discovered by audiences searching for entertainment options.",
      },
      {
        title: "Video Marketing & Trailer Optimization",
        description:
          "Strategic distribution and optimization of video assets to maximize impact and drive viewer interest across platforms.",
      },
      {
        title: "Entertainment Audience Targeting",
        description:
          "Precision targeting strategies that reach viewers with demonstrated interest in content similar to your offering.",
      },
    ],
    benefits: [
      {
        ...
        description:
          "Our specialists understand the unique challenges of marketing entertainment products and streaming services.",
      },
      {
        title: "Full-Funnel Optimization",
        description:
          "We optimize every stage from initial awareness through subscription signup and ongoing retention.",
      },
      {
        title: "Content-Centric Approach",
        description:
          "Our strategies leverage your strongest content assets to differentiate your platform in a crowded marketplace.",
      },
      {
        title: "Mobile-First Video Experiences",
        description:
          "We prioritize excellent mobile experiences, recognizing that over 60% of video consumption now happens on mobile devices.",
      },
      {
        title: "Data-Driven Content Recommendations",
        description:
          "Our analytics help identify which content resonates with specific audience segments to improve targeting and messaging.",
      },
    ],
    caseStudies: [
      {
        ...
        description:
          "Developed comprehensive subscriber acquisition strategy for a specialized streaming service focused on documentary content.",
        results: [
      ...
      },
      {
        ...
        description:
          "Created multi-platform content marketing strategy for a production company launching original series across various distribution channels.",
        results: [
    ...
    testimonials: [
      {
        quote:
          "Leadwisee's understanding of the OTT space is exceptional. Their subscriber acquisition strategies helped us surpass our growth targets while actually reducing our marketing spend.",
        name: "Chris Anderson",
        position: "VP of Marketing",
      ...
      {
        quote:
          "The audience targeting and content promotion strategies Leadwisee developed have significantly improved both our subscriber growth and retention rates. They truly understand how to market entertainment content.",
        name: "Sarah Jackson",
...
export const CoachingMarketingPage = () => {
  const pageData = {
    ...
    title:
      "Coaching & Consulting Marketing Agency: High-Ticket Client Acquisition",
    subtitle:
      "Premium Lead Generation Strategies for Coaches, Consultants & Course Creators",
    ...
    services: [
      {
        ...
        description:
          "Strategic marketing campaigns designed to attract qualified, high-value clients who are ready to invest in premium coaching and consulting services.",
      },
      {
        title: "Authority Positioning & Personal Branding",
        description:
          "Comprehensive strategies to establish you as the recognized expert in your field through thought leadership content and strategic visibility.",
      },
      {
        title: "Webinar & Event Marketing",
        description:
          "End-to-end webinar funnel optimization from registration to attendance to conversion, maximizing the effectiveness of your knowledge-sharing events.",
      },
      {
        title: "Course & Program Launch Strategies",
        description:
          "Specialized marketing campaigns for launching online courses, group programs, and membership sites with maximum enrollment and revenue.",
      },
      {
        title: "Coaching Business SEO & Content Strategy",
        description:
          "Targeted content creation and search optimization that positions your expertise for ideal clients searching for solutions you provide.",
      },
      {
        title: "Coaching Sales Funnel Optimization",
        description:
          "Strategic refinement of your entire client journey from first touch to discovery call to enrollment, improving conversion at each stage.",
      },
    ],
    benefits: [
      {
        ...
        description:
          "Our strategies prioritize attracting fewer, higher-quality prospects who are ideal matches for your premium offerings.",
      },
      {
        title: "Expertise in High-Ticket Marketing",
        description:
          "We understand the unique dynamics of selling premium services and how to market high-investment offerings effectively.",
      },
      {
        title: "Authentic Authority Building",
        description:
          "Our approach builds genuine thought leadership that establishes lasting credibility in your specific expertise area.",
      },
      {
        title: "Mobile-First Client Experience",
        description:
          "We create seamless mobile experiences throughout your marketing funnel, recognizing that busy professionals often engage on mobile devices.",
      },
      {
        title: "Results-Based Positioning",
        description:
          "Our messaging strategies focus on the transformational outcomes you deliver rather than just features of your offerings.",
      },
    ],
    caseStudies: [
      {
        ...
        description:
          "Developed comprehensive marketing strategy for a business coach offering high-ticket 1:1 consulting and group mastermind programs.",
        results: [
      ...
      },
      {
        ...
        description:
          "Created strategic launch campaign for a premium online course in the personal development space.",
        results: [
    ...
    testimonials: [
      {
        quote:
          "The client acquisition strategy Leadwisee developed transformed my coaching business. I'm now attracting fewer but far more qualified leads, and my conversion rates and client quality have dramatically improved.",
      ...
      {
        quote:
          "Leadwisee's understanding of marketing for high-ticket services is exceptional. Their strategies helped me position my expertise more effectively and attract clients who truly value and can afford my premium offerings.",
...
export const InteriorDesignMarketingPage = () => {
  const pageData = {
    ...
    subtitle:
      "Digital Marketing Strategies for Interior Designers & Architects",
    ...
    services: [
      {
        ...
        description:
          "Strategic enhancement of your digital portfolio to showcase your best work in ways that resonate with your ideal clients and highlight your unique style.",
      },
      {
        title: "Interior Design Lead Generation",
        description:
          "Targeted campaigns to attract qualified prospects actively seeking design services for projects that match your expertise and preferred scope.",
      },
      {
        title: "Luxury Project Marketing",
        description:
          "Specialized strategies for promoting high-end residential and commercial design services to affluent clients and luxury property developers.",
      },
      {
        title: "Design Platform Optimization",
        description:
          "Strategic management of your presence on platforms like Houzz, Pinterest, and Instagram to maximize visibility with design-focused audiences.",
      },
      {
        title: "Interior Design SEO & Content",
        description:
          "Specialized search optimization and content creation that helps potential clients find your design services when searching for inspiration or providers.",
      },
      {
        title: "Visual Social Media Management",
        description:
          "Sophisticated social strategies that showcase your portfolio and design aesthetic to build following and generate qualified inquiries.",
      },
    ],
    benefits: [
      {
        ...
        description:
          "Our strategies prioritize the visual elements of your brand, recognizing that aesthetic impression is crucial in the design industry.",
      },
      {
        title: "Project Quality Focus",
        description:
          "We focus on attracting fewer but higher-quality projects that match your preferred scope, budget range, and design style.",
      },
      {
        title: "Design Industry Expertise",
        description:
          "Our specialists understand the unique client journey for design services and how to nurture prospects effectively.",
      },
      {
        title: "Mobile-First Portfolio Experience",
        description:
          "We ensure your work is beautifully presented across all devices, including tablets and phones where many clients browse design inspiration.",
      },
      {
        title: "Multi-Platform Integration",
        description:
          "Our approaches coordinate your presence across design-specific platforms and traditional marketing channels for maximum impact.",
      },
    ],
    caseStudies: [
      {
        ...
        description:
          "Developed comprehensive digital strategy for a high-end interior design firm specializing in luxury residential projects.",
        results: [
      ...
      },
      {
        ...
        description:
          "Created targeted lead generation campaign for an architecture firm seeking to attract more commercial renovation projects.",
        results: [
    ...
    testimonials: [
      {
        quote:
          "Leadwisee transformed our digital presence and helped us attract exactly the kind of high-end residential clients we specialize in. Their understanding of the design industry is exceptional.",
        name: "Alexandra Chen",
      ...
      {
        quote:
          "The lead generation strategy Leadwisee developed has significantly improved both the quantity and quality of project inquiries. We're now able to be more selective with the projects we take on.",
